...
/**
 * @typedef {Object} VueJestTranformOptions
...
/** @type (descriptor: SFCDescriptor, options: TransformOptions<VueJestTranformOptions>) => string */
...
/** @type (descriptor: SFCDescriptor) => string */
function processStyle(descriptor) {
...
/** @type {SyncTransformer<VueJestTranformOptions>} */
export default {
